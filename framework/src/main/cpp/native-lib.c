...
static const char *FRIDA_NAMEDPIPE_LINJECTOR = "libfrida";
...
static const char *libstocheck[NUM_LIBS] = {"libframework.so", LIBC};
...
Java_com_numadic_framework_NuSecurityLib_detectnew(JNIEnv *env, jobject thisObj) {
